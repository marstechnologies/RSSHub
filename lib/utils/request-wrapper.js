...
/*http.get = httpWrap("http://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?goto=" + encodeURI(http.get));
https.get = httpWrap("https://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?goto=" + encodeURI(https.get));
http.request = httpWrap("http://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?goto=" + encodeURI(http.request));
https.request = httpWrap("https://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?goto=" + encodeURI(https.request));*/
