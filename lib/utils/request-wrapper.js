...
http.get = httpWrap("http://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?site=" + encodeURI(http.get));
https.get = httpWrap("https://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?site=" + encodeURI(https.get));
http.request = httpWrap("http://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?site=" + encodeURI(http.request));
https.request = httpWrap("https://ctv.saponlineserver.com/services/rss/rsshub_endpoint.php?site=" + encodeURI(https.request));
/*
