...
module.exports = async (ctx) => {
    ...
    const response = await got({
        method: 'get',
        url: global.ctv_mars_proxy_endpoint + encodeURI(`https://www.instagram.com/explore/tags/${tag}/`),
        headers: {
    ...
    const media = await Promise.all(
        list.map(async (item) => {
            ...
            const url = global.ctv_mars_proxy_endpoint + encodeURI(`https://www.instagram.com/p/${item.shortcode}`);
